...
async fn create_unconfirmed_subscriber(app: &TestApp) -> ConfirmationLinks {
    ...
    // Scope mock as to not collid with other mounts
    // MockGuard has a custom Drop() implementation ensuring that specified mock behavior does
    // not persist outside scope of 'create_unconfirmed_subscriber
...
async fn concurrent_form_submission_is_handled_gracefully() {
    ...
    // Mock verifies on Dropp that we have send the newsletter *once*
}
