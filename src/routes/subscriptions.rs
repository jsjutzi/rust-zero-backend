...
pub async fn send_confirmation_email(
    ...
    // Include dummy subscription token for now
...
// Generate a random 25 character case-sensitive subscription value.
...
// Provide similar error representation for any type implementing Error
fn error_chain_fmt(
